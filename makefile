...
FCFLAGS = -c -g -std=gnu99 -D_GNU_SOURCE -Wextra -Wpedantic -Wall -I $(SPAMADIR)/src/main/include   -I /msu/res5/software/myUsr/include -I/msu/res5/software/myUsr/include/ -I /msu/res1/Software/matio-1.5.1/src
#lapack
...
FCFLAGS = -c  -std=gnu99 -D_GNU_SOURCE -Wextra -Wpedantic -Wall -g -I $(SPAMADIR)/src/main/include   -I /Users/garyanderson/myUsr/include/ -I/Users/garyanderson/myUsr/include/\
-I /usr/local/Cellar/libmatio/1.5.10/include
#lapack
